    ...
    try {
      ...
      ParsedExcelRows = jsonRows.map(row => {
        ...
        return {
          ...
          direccion_destino: getValue("DIRECCION_DESTINO", "Dirección Destino", "DIRECCION", "Dirección") || "AV. LO ESPEJO 3200",
          comuna_destino: getValue("COMUNA_DESTINO", "Comuna Destino", "COMUNA", "Comuna") || "CERILLOS",
          ...
          vendedor: getValue("VENDEDOR", "Vendedor", "vendedor", "VENDEDOR_NOMBRE", "NOMBRE_VENDEDOR", "Vendedora", "VENDEDOR/A", "Vendedor/a", "EJECUTIVO", "Ejecutivo", "COD_VENDEDOR", "Cod Vendedor") || "COMERCIALIZADORA ELEODORO",
